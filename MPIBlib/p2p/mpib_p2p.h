...
/*!
 * This routine initializes the maximum fragment size for p2p benchmarks by reading the environment variable FRAGMENT_SIZE
 * at all processes. If it is not defined, no fragmentation will occur.
*/
...
int MPIB_Irecv_wrapper(void* buf, int count, MPI_Datatype datatype, int source,
